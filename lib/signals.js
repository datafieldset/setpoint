...
export const SIGNAL_RATES = {
  ...
  "EMA cross up|5m|bull": { rate: 0.59, runs: 1 },
  "Volume spike|15m|bull": { rate: 0.67, runs: 1 },
  "EMA cross down|1h|bear": { rate: 0.19, runs: 1 },
  "Volume spike|30m|bull": { rate: 0.28, runs: 1 },
  "Volume spike|5m|bear": { rate: 0.30, runs: 1 },
  "RSI overbought|15m|bear": { rate: 0.22, runs: 1 },
  "EMA cross down|30m|bear": { rate: 0.00, runs: 1 },
...
export function computeSignals(candles, tfKey, th, opts = {}) {
  ...
  if (bias && bias.dir && risk && risk.level !== "low") {
    ...
    signals.push({ type: "reversal", label: "Reversal watch", dir, strength, volTag: vc.tag, tier: pc.tag, tierRate: pc.rate, note, ...levels(price, a, dir) });
  }
