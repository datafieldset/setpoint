...
// Reversal-risk is deliberately NOT a score adjustment. Predicting when a
// stretched move actually turns is speculative, and baking another guess
// into every signal's strength is exactly the mistake a slow, one-shot
// trend filter already made once. This stays a visible awareness flag,
// surfaced to the person and to the AI reasoning layer, not silently folded
// into ranking. Combines how stretched the current bias is with whether
// sentiment (Fear & Greed) is sitting at an extreme, a classic contrarian
// signal professional desks actually watch.
