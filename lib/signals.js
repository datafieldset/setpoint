...
//   (Everything else below has been tested and cut — see SIGNAL_RATES'
//   own comments for the real, dated evidence behind each cut.)
//
...
export const SIGNAL_RATES = {
  ...
  "Volume spike|30m|bull": { rate: 0.41, runs: 1 }, // real, direct audit (Sep 4): 182W/266L on 448 real fires over ~90 real days, bias-gate correctly applied, genuinely below the bar on a large sample, cut
