...
//   Whale Flow  — bull & bear, 4h only. A large, real Coinbase trade
//            landing on a genuinely oversold (buy) or overbought
//            (sell) market — real, close to the bar (57%/55% in real,
//            deep testing) but not quite there yet.
//
...
// accumulation, Breakout/Breakdown, Whale Flow) is still real, active
...
export const TESTING_SIGNALS = ["Coil", "Swing", "Swing Early", "Whale Flow"];
...
export const ALL_SIGNALS = [
  ...
  { name: "Grind Up", what: "A sustained, steady climb, not a sudden spike — real, repeated upward pressure over several bars. Retired (Sep 24): tested more thoroughly than almost any other signal here, genuinely never worked under any real condition tried." },
  { name: "Grind Down", what: "The real, direct mirror of Grind Up — a sustained, steady move down." },
  ...
  { name: "Whale Flow", what: "A real, unusually large trade on Coinbase, landing on a genuinely oversold (a real buy) or overbought (a real sell) market at that exact moment — the size alone was tested and cut, this only fires when it lands on a real, matching extreme too." },
];
