...
export const SIGNAL_RATES = {
  "EMA cross up|30m|bull": { rate: null, needsRetest: true },
  ...
  // Updated from an older 30% single-run read to a larger, more recent
  // 39-sample run.
  "Volume spike|5m|bear": { rate: 0.19, runs: 1 },
  "RSI overbought|15m|bear": { rate: 0.19, runs: 2 }, // 22% then 19% on a 58-sample run
  ...
  // Small-sample 67% from one run got overturned by a clean 26-sample
  // run at 21%. The small-sample number was noise.
  "EMA cross down|15m|bear": { rate: 0.21, runs: 1 },
  "RSI overbought|1h|bear": { rate: 0.24, runs: 1 },
  "EMA cross down|5m|bear": { rate: null, needsRetest: true },
};
