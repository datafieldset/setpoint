...
// password already in use, verified2026, not a new secret to manage.
//
// Two ways in, since these routes get called two different ways:
// - checkKey(req): a ?key=verified2026 query parameter, for machine callers
